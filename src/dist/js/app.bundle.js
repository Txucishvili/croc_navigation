...
var appInitilize = '.app';
var API_CATEGORY_LINK = 'https://www.lionsbet.com/rest/market/categories';

function buildTemplate(element, parent) {
  $(element).each(function () {
    var element = this;
    var name = this.categoryName + ' - ' + this.level;
    var attachedElement = this.level >= 3 ? '' : '<div class="count">' + this.eventsCount + '</div>';
    var listItem = $('<li class="mainNavigation scope-' + this.level + '" data-category="' + this.categoryId + '" data-level="' + this.level + '">\n                        <div class="name"><b>' + this.categoryName + '</b> ' + attachedElement + '</div>\n                      </li>');
    if (this.hasOwnProperty("children") && this.children.length) {
      var tree = $("<ul />", { class: 'child' });
...
var easeWayCollect = function easeWayCollect(el, data) {
  var tree = [];
  var childCategory = {};
  var item = void 0,
      id = void 0,
      parrentCategory = void 0,
      navigation = void 0;
  var ulElement = $("<ul />", { class: 'navigation' });
...
$(appInitilize).on('click', '.navigation li.mainNavigation', function (e) {
  var item = $(e.target);
...
var loaderInit = function loaderInit(data) {
  var frameLoader = $("<div />", { class: 'frame-loader navLoader' });
  var frameLoaderCount = 12;

  if (data === true) {
    $(appInitilize).append(frameLoader);

    for (var i = 0; i < frameLoaderCount; i++) {
      var frame = frameLoaderCount[i];
...
var getCategory = _axios2.default.get(API_CATEGORY_LINK).then(function (resp) {
  setTimeout(function () {
    loaderInit(false);
